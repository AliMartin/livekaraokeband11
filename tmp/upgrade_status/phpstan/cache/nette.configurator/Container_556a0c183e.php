...
class Container_556a0c183e extends _PHPStan_5adafcbb8\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0437(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_556a0c183e $container)
			{
	...
	public function createServiceContainer(): Container_556a0c183e
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'REQUEST_URI' => '/admin/reports/upgrade-status/analyze/lkb10app',
